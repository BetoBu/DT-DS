...
# Subdirectorio por namespace para no pisar archivos entre robots
    src_output_path = os.path.join(src_config_path, namespace)
    install_output_path = os.path.join(install_config_path, namespace)
    ...
    for config_path in [src_output_path, install_output_path]:
